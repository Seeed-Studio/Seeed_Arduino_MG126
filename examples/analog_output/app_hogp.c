...
extern char analog_str[10];

#define SOFTWARE_INFO "V1.0.0"
#define MANU_INFO     "Seeeduino"
char DeviceInfo[14] =  "Wio_BLE_Analog";  /*max len is 24 bytes*/
...
// ======  device info =====    Do NOT Change if using the default!!!  
    ...
    {TYPE_CHAR,0x11,ATT_CHAR_PROP_RD|ATT_CHAR_PROP_NTF, 0x12,0, 0x58,0x2A, UUID16_FORMAT},//Temperature
...
void server_rd_rsp(u8 attOpcode, u16 attHandle, u8 pdu_type)
{
    ...
    switch(attHandle) //hard code
    {
        ...
        case 0x12:
            att_server_rd( pdu_type, attOpcode, attHandle, analog_str, strlen(analog_str));
            break;
