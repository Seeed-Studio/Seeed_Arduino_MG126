...
#define MANU_INFO     "Seeedino Bluetooth"
char DeviceInfo[14] =  "Wio_Led_matrix";  /*max len is 24 bytes*/
...
// ======  User service or other services added here =====  User defined  
    {TYPE_CHAR,0x0011, {ATT_CHAR_PROP_NTF|ATT_CHAR_PROP_W,     0x12,0, 0,0}, 1/*uuid128-idx1*/ },
    // {TYPE_CFG, 0x0013, {ATT_CHAR_PROP_RD|ATT_CHAR_PROP_W}},                     //cfg    
    // {TYPE_CHAR,0x0014, {ATT_CHAR_PROP_W|ATT_CHAR_PROP_W_NORSP, 0x15,0, 0,0}, 2/*uuid128-idx2*/ },

};

const BLE_UUID128 AttUuid128List[] = {
    /*for supporting the android app [nRF UART V2.0], one SHOULD using the 0x9e,0xca,0xdc.... uuid128*/
    {0x9e,0xca,0xdc,0x24,0x0e,0xe5,0xa9,0xe0,0x93,0xf3,0xa3,0xb5,0X10,0,0x40,0x6e}, 
    {0x9e,0xca,0xdc,0x24,0x0e,0xe5,0xa9,0xe0,0x93,0xf3,0xa3,0xb5,6,0X11,0x40,0x6e}, 
    {0x9e,0xca,0xdc,0x24,0x0e,0xe5,0xa9,0xe0,0x93,0xf3,0xa3,0xb5,7,0,0x40,0x6e}, 
    {0x9e,0xca,0xdc,0x24,0x0e,0xe5,0xa9,0xe0,0x93,0xf3,0xa3,0xb5,8,0,0x40,0x6e}, 
};
                   ...
                   uint16_t att_hd, uint8_t* attValue/*app data pointer*/, uint8_t valueLen_w/*app data size*/)
{
    ...
    switch(att_hd)
    {
        ...
        case 0x12://cmd
            ...
            memcpy(ble_recv_data.buf,attValue,valueLen_w);
            ble_recv_data.recv_len = valueLen_w;
            break;
